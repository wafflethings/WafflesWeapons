...
public class ConductorBehaviour : GunBehaviour<ConductorBehaviour>
{
    ...
    private void Shoot()
    {
        ...
        IStunProjectile projectile = Instantiate(ChargeProjectile, Nailgun.cc.transform.position + Nailgun.cc.transform.forward, Nailgun.cc.transform.rotation).GetComponent<IStunProjectile>();
