...
public class SpawnableObjectEditor : Editor
{
    ...
    private SerializedProperty sandboxOnly;
    ...
    private SerializedProperty triggerOnly;
    ...
    private void OnEnable()
    {
        ...
        sandboxOnly = serializedObject.FindProperty("sandboxOnly");
        ...
        triggerOnly = serializedObject.FindProperty("triggerOnly");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(sandboxOnly);
        ...
        if (spawnableObjectType.intValue != (int) SpawnableObject.SpawnableObjectDataType.Tool)
        {
            ...
            EditorGUILayout.PropertyField(triggerOnly);
        }
